<!-- Copia coordinata con .claude/commands/handoff.md e .agent/workflows/handoff.md.
...
Equivalente Antigravity 2.0 Skill del comando `/handoff` (`.claude/commands/handoff.md`). Stesso
contenuto, registrato come skill in `.agent/skills/handoff/SKILL.md` per abilitare
l'autocomplete del comando slash `/handoff` nell'interfaccia chat di Antigravity.
