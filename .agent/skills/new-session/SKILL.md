<!-- Copia coordinata con .claude/commands/new-session.md e .agent/workflows/new-session.md.
     Formato skill Antigravity 2.0 (SKILL.md con frontmatter YAML name + description).
     Se modifichi questo file, aggiorna anche le altre versioni per mantenerle allineate. -->
---
name: new-session
...
Equivalente Antigravity 2.0 Skill del comando `/new-session` (`.claude/commands/new-session.md`).
Stesso contenuto, registrato come skill in `.agent/skills/new-session/SKILL.md` per abilitare
l'autocomplete del comando slash `/new-session` nell'interfaccia chat di Antigravity.
