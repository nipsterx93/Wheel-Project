...
scope:      AGENTS.md; .ai/ (PROJECT_STATE, ARCHITECTURE, HANDOFF_LOG, archive, plans, STRATEGY_ENGINE_GUIDE, NEW_SESSION_PROMPT); .claude/hooks/check-lock.js; .claude/commands/new-session.md; .agent/workflows/new-session.md
