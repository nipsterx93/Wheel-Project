...
- **⏸️ Sospeso il 2026-09-15:** superato dalla riscrittura del plugin (`.ai/plans/2026-09-15-remastered-spec.md`). Passi 1 e 2 fatti e verificati; i passi 3-5 e Y-62 non si eseguono sul plugin vecchio, i loro numeri servono da riferimento per le logiche nuove.
